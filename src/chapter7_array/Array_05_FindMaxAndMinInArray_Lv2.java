...
public class Array_05_FindMaxAndMinInArray_Lv2 {
    public static void main(String[] args) {
        ...
        // 작성위치
        for (int j : array) {
            if (max < j) {    // 배열의 요소가 max 보다 큰지 확인
                max = j;    // 배열의 요소가 max 보다 크다면 요소값을 max변수에 저장
                System.out.println("최대값 업뎁이트 : " + max); // 테스트 코드. max 변수에 1, 5 ,8 순으로 들어감
            }
        }
