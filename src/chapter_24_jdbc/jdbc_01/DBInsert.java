...
/**
 * DBInsert 클래스는 JDBC를 사용하여 데이터베이스에 사용자 정보를 삽입하는 역할을 합니다.
...
public class DBInsert extends DB {
    ...
    /**
     * 콘솔에서 사용자 정보를 입력받아 User 객체를 반환하는 메서드입니다.
     *
     * @return User 객체, 입력된 사용자 정보를 포함합니다.
     * @throws SQLException 데이터베이스 접근 에러 시 예외를 던집니다.
     */
...
//            System.out.println(validate);
    ...
    public void insertUser() throws SQLException {
        ...
        // SQL INSERT 문 작성
        String insertSql = " INSERT INTO sample_jdbc_01.tuser (userID, name, age, job) VALUES (?,?,?,?) ";
...
//        preparedStatement = conn.prepareStatement(insertSql); // 쿼리 실행 준비
    ...
    /**
     * 사용자 아이디의 중복을 검사하는 메서드입니다.
     *
     * @param userID 검사할 사용자 아이디
     * @return 중복이면 true, 아니면 false를 반환합니다.
     * @throws SQLException 데이터베이스 접근 에러 시 예외를 던집니다.
     */
