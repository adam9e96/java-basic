package chapter20.innerClass01;
...
class OutClass {
    /*
       ...
       내부 클래스의 특징
         - 내부 클래스는 외부 클래스의 인스턴스 변수와 메서드에 쉽게 접근할 수 있습니다. 이는 내부 클래스가 외부 클래스의 멤버들과 밀접한 관련이 있을 때 유용합니다.
         - 내부 클래스는 외부 클래스의 private 멤버에도 접근할 수 있습니다. 이는 데이터 은닉(data hiding)을 유지하면서도 내부 구현 세부사항을 외부에 노출하지 않으면서 유용하게 활용할 수 있습니다.
     */
