...
(
    ...
    accountType   int            NOT NULL,        # 계좌종류 (1: 예금계좌, 2: 대출계좌)
...
(
    accountHistoryId int auto_increment primary key,
    memberId         int not null,
    accountId        int not null, # 계좌번호

    CONSTRAINT UNIQUE_AH unique (memberId,accountId),
