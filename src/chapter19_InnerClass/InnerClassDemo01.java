...
/**
 * Student 클래스는 학생의 정보를 관리하고, 학생이 수강하는 과목을 관리하는 기능을 제공합니다.
 * 이 클래스는 학생의 ID, 이름, 성적을 속성으로 가지며, 수강 과목 관리를 위해 내부 클래스 Course를 포함합니다.
 */
class Student { // 외부 클래스
    private String studentID; // 학생의 고유 아이디
    private String studentName; // 학생의 이름
    private int score; // 학생의 성적
    private int index = 0; // 과목 배열의 인덱스
    private Course[] courses = new Course[10]; // 학생이 수강하는 과목들을 저장할 배열, 최대 10과목
    ...
    /**
     * Course 클래스는 Student 클래스의 내부 클래스이며,
     * 학생이 수강하는 개별 과목의 이름과 성적을 관리합니다.
     */
    class Course {  // 내부 클래스
        ...
        /**
         * Course 클래스의 생성자로, 과목명과 과목 성적을 초기화합니다.
         *
         * @param courseName  수업 과목명
         * @param courseGrade 과목 성적 (A, B, C, D, F 중 하나)
         */
    ...
    /**
     * Student 클래스의 생성자로, 학생의 ID와 이름을 초기화합니다.
     *
    ...
    /**
     * 수업 과목명과 성적을 받아 Course 객체를 생성하고, 이를 courses 배열에 추가합니다.
     *
     * @param courseName  수업 과목명
     * @param courseGrade 과목 성적 (A, B, C, D, F 중 하나)
     */
    ...
    /**
     * 학생이 수강한 모든 과목의 목록을 배열로 반환합니다.
     *
     * @return Course 객체 배열, 학생이 수강한 과목 목록
     */
    ...
    /**
     * 학생이 수강한 과목의 개수를 반환합니다.
     *
     * @return 현재까지 추가된 과목의 수
     */
    public int getIndex() {
        return index;
    }
...
/**
 * Exam01 클래스는 프로그램의 진입점으로, Student 객체를 생성하고 여러 과목을 추가한 후,
 * 해당 학생의 수강 과목 목록을 출력하는 역할을 합니다.
 */
public class InnerClassDemo01 {
    /**
     * 프로그램의 메인 메서드로, Student 객체를 생성하고 수강 과목을 추가한 후,
     * 학생의 수강 과목과 성적을 출력합니다.
     *
    ...
    public static void main(String[] args) {
        ...
        Student.Course[] courses = student.getCourseList(); // 수강 과목 목록 가져오기
